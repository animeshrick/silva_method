...
curriculumView({required bool isActive}){
  return   ExpansionPanel(
    ...
    headerBuilder: (context, isExpanded) {
      return Padding(
        ...
        child: Row(
          children: [
            Icon(isActive?Icons.auto_stories_outlined:Icons.import_contacts_outlined,color: isActive?Colors.amber:Colors.black,),
            customTextExtraBold(
                ' Curriculum', Colors.black, 16),
          ],
        ),
      );
    },
