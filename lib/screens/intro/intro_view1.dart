...
class IntroView1 extends StatefulWidget {
  const IntroView1({Key? key}) : super(key: key);

  @override
  State<IntroView1> createState() => _IntroView1State();
}

class _IntroView1State extends State<IntroView1> {
  ...
  //   //     ),
  //   //   );
  //     Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_)=> IntroView2()));
  //   });
  // }
